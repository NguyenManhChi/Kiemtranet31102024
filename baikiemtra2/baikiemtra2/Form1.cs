...
namespace baikiemtra2
{
    public partial class Form1 : Form
    {
        ...
        private void LoadProducts()
        {
            ...
            products.Add(new Product { Name = "Áo sơ mi", Price = 55500000, Quantity = 111  });
            products.Add(new Product { Name = "Quần âu", Price = 7200000, Quantity = 522  });
            products.Add(new Product { Name = "Váy ", Price = 2100000, Quantity = 288  });
        }
